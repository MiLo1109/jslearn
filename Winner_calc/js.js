...
let avgRes = (res1, res2, res3) => (res1 + res2 + res3) / 3

const crazyKats = 'CrazyKats'
const funnyDucks = 'FunnyDucks'

let resultCrazyKats = avgRes(23, 34, 27)
let resultFunnyDucks = avgRes(85, 54, 41)

function winner(resFirstTeam, resSecondTeam) {
    if (resFirstTeam > resSecondTeam * 2) {
        alert(`Команда ${crazyKats} выиграла`)
    } else if (resFirstTeam * 2 < resSecondTeam) {
        alert(`Команда ${funnyDucks} выиграла`)
    } else alert('У команд ничья')
}

winner(resultCrazyKats, resultFunnyDucks)
